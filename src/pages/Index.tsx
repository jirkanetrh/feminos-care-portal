          ...
          <div id="online" className="grid sm:grid-cols-2 gap-6 max-w-3xl mx-auto">
            ...
            <div className="bg-white rounded-2xl border border-[hsl(var(--border))] p-8 flex flex-col items-center text-center gap-4">
              ...
              <h3 className="text-base font-semibold text-foreground leading-snug" style={{ fontFamily: "var(--font-display)" }}>
                Naše pacientky,<br />
                <span className="font-semibold text-[15px] text-muted-foreground">které mají v ordinaci již registrovaný <span className="whitespace-nowrap">e-mail.</span></span>
              </h3>
            ...
            <div className="bg-white rounded-2xl border border-[hsl(var(--border))] p-8 flex flex-col items-center text-center gap-4">
              ...
              <h3 className="text-base font-semibold text-foreground leading-snug" style={{ fontFamily: "var(--font-display)" }}>
                Naše pacientky,<br />
                <span className="font-semibold text-[15px] text-muted-foreground">které doposud nemají registrovanou <span className="whitespace-nowrap">e-mailovou adresu.</span></span>
              </h3>
              <p className="text-muted-foreground text-sm leading-relaxed">
